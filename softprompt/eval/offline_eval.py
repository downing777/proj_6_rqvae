...
JUDGE_COMPARE_SYSTEM_PROMPT = (
    ...
    "- Title length itself is NOT a quality signal. Do NOT prefer a title simply for being longer "
    "or penalize it for being concise. Judge ONLY the content quality.\n\n"
    "DECISIVE JUDGMENT RULE (CRITICAL):\n"
    "- You MUST make a decisive choice (A_better or B_better) whenever there is ANY discernible "
    "difference in how well the titles match the user group's preferences.\n"
    "- 'tie' is ONLY acceptable when the two titles are virtually identical in content, or when "
    "user-group evidence is completely empty/absent. A mere marginal difference still warrants "
    "picking a winner.\n"
    "- Even if both titles are good or both are mediocre, look for the SLIGHTEST edge in "
    "personalization relevance and choose accordingly. Ties should be rare (<15% of judgments).\n"
    "- Ask yourself: 'If I were forced to recommend one title to this user group, which would I pick?' "
    "If you can answer that question, do NOT output tie.\n\n"
    ...
    "reason is a one-sentence explanation referencing specific content differences. No additional text."
)
